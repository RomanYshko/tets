...
define( 'SLACK_CLIENT_ID', '46723632583.88692023521' );
define( 'SLACK_CLIENT_SECRET', '43220b5e2346e61a90bdc35efc66ed7b' );
define( 'SLACK_COMMAND_TOKEN', 'xoxp-46723632583-46751667537-81167912309-22e0978a98' );
...
<html>
	...
	<body>
		...
		<?php else : ?>
			<p>
				<a href="http://slack.com/oauth/authorize?scope=incoming-webhook,commands&client_id=<?php echo $slack->get_client_id(); ?>"><img alt="Add to Slack" height="40" width="139" src="http://platform.slack-edge.com/img/add_to_slack.png" srcset="http://platform.slack-edge.com/img/add_to_slack.png 1x, http://platform.slack-edge.com/img/add_to_slack@2x.png 2x"></a>
			</p>
		<?php endif; ?>
