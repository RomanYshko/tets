...
abstract class RequestsTest_Transport_Base extends PHPUnit_Framework_TestCase {
	...
	public function testExpiredHTTPS() {
		...
		$request = Requests::get('http://testssl-expire.disig.sk/index.en.html', array(), $this->getOptions());
	}
	...
	public function testRevokedHTTPS() {
		...
		$request = Requests::get('http://testssl-revoked.disig.sk/index.en.html', array(), $this->getOptions());
	}
	...
	public function testBadDomain() {
		...
		$request = Requests::get('http://tv.eurosport.com/', array(), $this->getOptions());
	}
